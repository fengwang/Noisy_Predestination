...
mcnn.compile(loss='mse', optimizer=RMSprop())
...
image_path_0 = '/raid/feng/experimental_data/Data sets for NN denoising-Debora/original/too_large/2019_05_08-16.18abcd,2048px,8.9pm.tif.too_large.tif'
noisy_images_ = tifffile.imread( image_path_0 )
